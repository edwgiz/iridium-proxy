...
```text
# uname -a
Linux UMC_C3 4.1.15 #1 SMP PREEMPT Wed Apr 25 13:38:59 +05 2018 armv7l GNU/Linux
```
...
# ls -l /etc/init.d/
total 22
-rwxr-xr-x    1 root     root           649 Apr 25  2018 S01logging
-rwxr-xr-x    1 root     root          1516 Apr 25  2018 S02setup
-rwxr-xr-x    1 root     root          1630 Apr 25  2018 S10udev
-rwxr-xr-x    1 root     root          1321 Apr 25  2018 S20urandom
-rwxr-xr-x    1 root     root           438 Apr 25  2018 S40network
-rwxr-xr-x    1 root     root           675 Apr 25  2018 S49ntp
-rwxr-xr-x    1 root     root          1354 Apr 25  2018 S50dropbear
-rwxr-xr-x    1 root     root           531 Apr 25  2018 S50mosquitto
-rwxr-xr-x    1 root     root           427 Nov 30  2022 S92iridium
-rwxr-xr-x    1 root     root          1063 Apr 25  2018 gpioinit
-rwxr-xr-x    1 root     root          1921 Apr 25  2018 overlay
-rwxr-xr-x    1 root     root           423 Apr 25  2018 rcK
-rwxr-xr-x    1 root     root           408 Apr 25  2018 rcS
```

## Example
`# cat /etc/init.d/S92iridium`
```shell
#!/bin/sh

case "$1" in
  start)
	 printf "Starting iridium: "
	 /opt/iridiumserver/forebear.sh --start > /dev/null 2>&1
	 [ $? = 0 ] && echo "OK" || echo "FAIL"
	;;
  stop)
	 printf "Stopping iridium: "
         /opt/iridiumserver/forebear.sh --stop > /dev/null 2>&1
	 [ $? = 0 ] && echo "OK" || echo "FAIL"
	;;
  restart|reload)
	 "$0" stop
